...
```bash
git clone https://github.com/chernivtsi-space/HoReCa.git PROJECT_NAME
cd PROJECT_NAME
npm i
npm run start
```
...
rm -rf .git
git init
git remote add origin https://github.com/chernivtsi-space/PROJECT_NAME.git
git add .
...
and uploaded Knowledge files live in `projects/ngx-horeca/custom-gpt/`.
